...
func getConfig() *types.Configuration {
	...
	v.SetDefault("MutualTlsFilesPath", "/certs")
	...
	v.SetDefault("Rocketchat.CheckCert", false)
	...
	v.SetDefault("Mattermost.CheckCert", false)
	...
	v.SetDefault("Teams.CheckCert", false)
	...
	v.SetDefault("Datadog.CheckCert", false)
